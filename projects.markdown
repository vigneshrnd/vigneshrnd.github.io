...
<h4 style="text-align: center;"> Product Surface Area </h4>
...
<h4 style="text-align: center;"> Core Technologies </h4>
...
**Developer API:** Image Tagging, Image Similarity, Saliency
 <br>
<h4 style="text-align: center;">2017/18 </h4>
**User Experiences:** Photos Search, Memories, CreateML \
**Core Technologies:** Scene Analysis Backbone, Image Aesthetics, Saliency, Data Workflows                                            \
**Developer API:** ImagePrint Extraction, Custom CreateML Classifier Training
 <br>
...
**User Experiences:** Face Analysis in Portrait Mode, Face Recognition in Photos \
**Core Technologies:** Facial Landmarks, Face Recognition, Face Attributes \
 <br>